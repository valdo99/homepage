    ...
    <section className="my-28" id="contact">
      ...
      <div className="md:mx-6 flex flex-col flex-wrap md:flex-row justify-between">
        <div className="md:w-6/12 md:px-0 p-5 my-5">
          <div>
            <p className="font-bold">Edvaldo Gjonikaj</p>
            <p className="font-thin">Milano, Italy</p>
            <a
              href="mailto: edvaldo99@icloud.com"
              className="border-b-2 mt-3 inline-block border-gray-500"
            >
              edvaldo99@icloud.com
            </a>
          </div>
          <a
            className="border-b-2 mt-3 inline-block border-gray-500"
            href="./EdvaldoGjonikaj_CV.pdf"
            target="_blank"
            rel="noreferrer"
          >
            Resume
        ...
        <div className="bg-gray px-5 py-10 md:py-8 sm:p-8 my-2 md:rounded-lg shadow-lg  justify-between w-full  md:w-6/12 ">
          ...
          >
            ...
            <button
              type="submit"
              className="border border-gray-500 p-2 rounded-lg w-auto mr-auto shadow-md buttonhover"
            >
              Send Message
            </button>
          </form>
